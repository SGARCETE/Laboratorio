...
public ArrayList<Pedido> getENTREGA_PEDIDOS(Entrega ent) {
	...
	try {
		...
		"PD.PD_cliente= CL.CL_id and ENT.ENT_id= EP.EP_entrega_id and PD.PD_id= EP.EP_pedido_id and ENT.ENT_id = " + ent.getId() ;
...
//		System.out.println(SentenciaSQL_producto_pedidos);
	...
	public boolean ELIMINAR_PEDIDOS_DE_LA_ENTREGA(Entrega e) {
		String SentenciaSQL = "delete from Entrega_pedido where EP_entrega_id = " + e.getId();
...
public boolean MODIFICAR_ENTREGA(Entrega e) {
		...
		String SentenciaSQL = "UPDATE Entrega SET Ent_fecha_salida = '" + formato_yyyyMMdd.format(e.getFecha_salida()) + "', "
