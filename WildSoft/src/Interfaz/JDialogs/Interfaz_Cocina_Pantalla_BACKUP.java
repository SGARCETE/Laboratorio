...
public class Interfaz_Cocina_Pantalla_BACKUP extends JFrame {
	...
	public Interfaz_Cocina_Pantalla_BACKUP(Principal_Negocio_Interfaz Principal_neg_int) {
		setMinimumSize(new Dimension(1024, 768));
		setIconImage(Toolkit.getDefaultToolkit().getImage(Interfaz_Cocina_Pantalla_BACKUP.class.getResource("/Recursos/Pizza-icon16.png")));
		...
		gl_panel_prioridad1.setHorizontalGroup(gl_panel_prioridad1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_prioridad1.createSequentialGroup().addGap(10)
						.addComponent(lblPizza, GroupLayout.PREFERRED_SIZE, 95, GroupLayout.PREFERRED_SIZE).addGap(7)
						.addComponent(lbl_NroPedido_Prioridad1, GroupLayout.PREFERRED_SIZE, 68,
								GroupLayout.PREFERRED_SIZE)
						.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
				.addComponent(scrollPane_prioridad1, GroupLayout.DEFAULT_SIZE, 186, Short.MAX_VALUE));
		gl_panel_prioridad1
				.setVerticalGroup(gl_panel_prioridad1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_prioridad1.createSequentialGroup().addGap(9)
								.addGroup(gl_panel_prioridad1.createParallelGroup(Alignment.LEADING)
										.addComponent(lblPizza, GroupLayout.PREFERRED_SIZE, 27,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lbl_NroPedido_Prioridad1, GroupLayout.PREFERRED_SIZE, 27,
												GroupLayout.PREFERRED_SIZE))
		...
		gl_panel_prioridad2
				.setHorizontalGroup(
						gl_panel_prioridad2.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_prioridad2.createSequentialGroup().addGap(10)
										.addComponent(label_1, GroupLayout.PREFERRED_SIZE, 95,
												GroupLayout.PREFERRED_SIZE)
								.addGap(7)
								.addComponent(lbl_NroPedido_Prioridad2, GroupLayout.PREFERRED_SIZE, 68,
		...
		gl_panel_prioridad2
				.setVerticalGroup(gl_panel_prioridad2.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_prioridad2.createSequentialGroup().addGap(10)
								.addGroup(gl_panel_prioridad2.createParallelGroup(Alignment.LEADING)
										.addComponent(label_1, GroupLayout.PREFERRED_SIZE, 27,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lbl_NroPedido_Prioridad2, GroupLayout.PREFERRED_SIZE, 27,
												GroupLayout.PREFERRED_SIZE))
								.addGap(11)
		...
		gl_panel_prioridad3
				.setHorizontalGroup(
						gl_panel_prioridad3.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_prioridad3.createSequentialGroup().addGap(10)
										.addComponent(label_16, GroupLayout.PREFERRED_SIZE, 95,
												GroupLayout.PREFERRED_SIZE)
								.addGap(7)
								.addComponent(lbl_NroPedido_Prioridad3, GroupLayout.PREFERRED_SIZE, 68,
										GroupLayout.PREFERRED_SIZE).addContainerGap(12, Short.MAX_VALUE))
				.addComponent(scrollPane_prioridad3, GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE));
		gl_panel_prioridad3
				.setVerticalGroup(gl_panel_prioridad3.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_prioridad3.createSequentialGroup().addGap(10)
								.addGroup(gl_panel_prioridad3.createParallelGroup(Alignment.LEADING)
										.addComponent(label_16, GroupLayout.PREFERRED_SIZE, 27,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lbl_NroPedido_Prioridad3, GroupLayout.PREFERRED_SIZE, 27,
												GroupLayout.PREFERRED_SIZE))
								.addGap(11)
		...
		gl_panel_prioridad4
				.setHorizontalGroup(
						gl_panel_prioridad4.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_prioridad4.createSequentialGroup().addGap(10)
										.addComponent(label_30, GroupLayout.PREFERRED_SIZE, 95,
												GroupLayout.PREFERRED_SIZE)
								.addGap(7)
								.addComponent(lbl_NroPedido_Prioridad4, GroupLayout.PREFERRED_SIZE, 68,
										GroupLayout.PREFERRED_SIZE).addContainerGap(12, Short.MAX_VALUE))
				.addComponent(scrollPane_prioridad4, GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE));
		gl_panel_prioridad4
				.setVerticalGroup(gl_panel_prioridad4.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_prioridad4.createSequentialGroup().addGap(10)
								.addGroup(gl_panel_prioridad4.createParallelGroup(Alignment.LEADING)
										.addComponent(label_30, GroupLayout.PREFERRED_SIZE, 27,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lbl_NroPedido_Prioridad4, GroupLayout.PREFERRED_SIZE, 27,
												GroupLayout.PREFERRED_SIZE))
								.addGap(11)
		...
		gl_panel_prioridad5
				.setHorizontalGroup(
						gl_panel_prioridad5.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_panel_prioridad5.createSequentialGroup().addGap(11)
										.addComponent(label_44, GroupLayout.PREFERRED_SIZE, 95,
												GroupLayout.PREFERRED_SIZE)
								.addGap(7)
								.addComponent(lbl_NroPedido_Prioridad5, GroupLayout.PREFERRED_SIZE, 68,
										GroupLayout.PREFERRED_SIZE).addContainerGap(11, Short.MAX_VALUE))
				.addComponent(scrollPane_prioridad5, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 192,
						Short.MAX_VALUE));
		gl_panel_prioridad5
				.setVerticalGroup(gl_panel_prioridad5.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_prioridad5.createSequentialGroup().addGap(10)
								.addGroup(gl_panel_prioridad5.createParallelGroup(Alignment.LEADING)
										.addComponent(label_44, GroupLayout.PREFERRED_SIZE, 27,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lbl_NroPedido_Prioridad5, GroupLayout.PREFERRED_SIZE, 27,
												GroupLayout.PREFERRED_SIZE))
								.addGap(11)
				...
				.setHorizontalGroup(
						gl_panel_13
								.createParallelGroup(
										Alignment.LEADING)
								.addGroup(
										gl_panel_13.createSequentialGroup().addGap(5)
												.addComponent(panel_prioridad1, GroupLayout.DEFAULT_SIZE, 194,
														Short.MAX_VALUE)
												.addGap(5)
												.addComponent(panel_prioridad2, GroupLayout.DEFAULT_SIZE, 194,
														Short.MAX_VALUE)
												.addGap(5)
												.addComponent(panel_prioridad3, GroupLayout.DEFAULT_SIZE, 194,
														Short.MAX_VALUE)
												.addGap(5)
												.addComponent(panel_prioridad4, GroupLayout.DEFAULT_SIZE, 194,
														Short.MAX_VALUE)
												.addGap(4).addComponent(panel_prioridad5, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addGap(4)));
		gl_panel_13.setVerticalGroup(gl_panel_13.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_13.createSequentialGroup().addGap(5)
						.addGroup(gl_panel_13.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(panel_prioridad2, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
						.addComponent(panel_prioridad3, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)
						.addComponent(panel_prioridad4, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE).addComponent(panel_prioridad5, GroupLayout.DEFAULT_SIZE,
										GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addGap(6)));
		...
		gl_panel_11.setHorizontalGroup(gl_panel_11.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_11.createSequentialGroup().addGap(4)
						.addGroup(gl_panel_11.createParallelGroup(Alignment.LEADING)
								.addComponent(scrollPane_Detalles, GroupLayout.DEFAULT_SIZE, 655, Short.MAX_VALUE)
								.addGroup(gl_panel_11.createSequentialGroup().addGap(4).addComponent(lblDetalle_Pedido,
										GroupLayout.PREFERRED_SIZE, 467, GroupLayout.PREFERRED_SIZE)))
				.addGap(12)
				.addGroup(gl_panel_11.createParallelGroup(Alignment.LEADING)
						.addComponent(lblResumenUltimos, GroupLayout.DEFAULT_SIZE, 264, Short.MAX_VALUE)
						.addComponent(scrollPane_Resumen_Productos_Pendientes, GroupLayout.DEFAULT_SIZE, 264,
								Short.MAX_VALUE))
						.addGap(43)));
		gl_panel_11.setVerticalGroup(gl_panel_11.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_11.createSequentialGroup().addGap(30).addComponent(scrollPane_Detalles,
				...
				.addGroup(gl_panel_11.createSequentialGroup().addGap(30).addComponent(
						scrollPane_Resumen_Productos_Pendientes, GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)));
	...
	private void Mostrar_pedido(Pedido p, Integer Index) {
		...
		for (int i = 0; i < LISTA_PRODUCTOS_ORDENADA.size(); i++) {
			...
			if (!TIPO_PR_ACTUAL.equals(TIPO_PR) && pr.getPR_tipo_producto() != 3) {
