...
public class Interfaz_ABM_Combos extends JDialog {
	...
	public Interfaz_ABM_Combos(Principal_Negocio_Interfaz principal_neg_int) {
		...
		btn_Agregar.setIcon(new ImageIcon(Interfaz_ABM_Combos.class.getResource("/Recursos/IMG/Check-3-icon16.png")));
		...
		Modificar_Cantidad.setIcon(new ImageIcon(Interfaz_ABM_Combos.class.getResource("/Recursos/IMG/sign-check-icon24.png")));
		...
		btnGuardarModificacionPedido.setIcon(new ImageIcon(Interfaz_ABM_Combos.class.getResource("/Recursos/IMG/sign-check-icon24.png")));
