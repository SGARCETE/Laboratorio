...
Insert INTO Cliente VALUES (1,"Vacio","Vacio","Vacio") ;
INSERT INTO `cliente` VALUES (2,'Vergara 1567','4456-9874','Javier Pérez'),(3,'Belgrano 100','4456-9292','Daniel Osvaldo'),(4,'Zapiola 1455','4555-2356','Pedro Suarez'),(5,'Zapiola 1454','4555-2356','Martin Safe');
...
CREATE TABLE `pedido` (
  ...
  `PD_Delivery` boolean DEFAULT FALSE,
  PRIMARY KEY (`PD_id`),
...
INSERT INTO `pedido` VALUES (1,'2015-10-03',1,1,NULL,false),
(2,'2015-10-03',1,1,NULL,false),
(3,'2015-10-03',1,1,NULL,false),
(4,'2015-10-03',1,1,NULL,false),
(5,'2015-10-03',1,1,NULL,false),
(6,'2015-10-03',1,1,NULL,false),
(7,'2015-10-03',1,1,NULL,false),
(8,'2015-10-03',1,1,NULL,false),
(9,'2015-10-03',1,1,NULL,false),
(10,'2015-10-03',1,1,NULL,false),
(11,'2015-10-03',4,1,NULL,false),
(12,'2015-10-03',1,1,NULL,false),
(13,'2015-10-03',1,2,NULL,false),
(14,'2015-10-03',1,1,NULL,false),
(15,'2015-10-03',1,1,NULL,false),
(16,'2015-10-03',1,1,NULL,false),
(17,'2015-10-03',1,2,NULL,false),
(18,'2015-10-04',1,3,NULL,false),
(19,'2015-10-04',1,5,NULL,false),
(20,'2015-10-04',1,4,NULL,false),
(21,'2015-10-04',1,2,NULL,false);
